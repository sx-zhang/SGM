...
def init_vis_image(goal_name, legend, num_pf_maps=0, add_sem_seg=False):
    ...
    vis_image[49, 1165:1645] = color # yxy
    vis_image[49, 1660:2140] = color # yxy
    vis_image[530, 1165:1645] = color # yxy
    vis_image[530, 1660:2140] = color # yxy
    vis_image[50:530, 14] = color
    vis_image[50:530, 655] = color
    vis_image[50:530, 1164] = color # yxy
    vis_image[50:530, 1645] = color # yxy
    vis_image[50:530, 1659] = color # yxy
    vis_image[50:530, 2140] = color # yxy
    # Semantic map
    ...
    if add_sem_seg:
        ...
        vis_image[49:530, 2154] = color
        vis_image[49:530, 2795] = color
        vis_image[49, 2154:2795] = color
        vis_image[530, 2154:2795] = color
